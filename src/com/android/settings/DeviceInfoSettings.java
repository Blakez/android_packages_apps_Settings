...
public class DeviceInfoSettings extends SettingsPreferenceFragment {
    ...
    private static final String KEY_PK_VERSION = "pk_version";
    private static final String KEY_DEVELOPER_VERSION = "developer_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_DEVELOPER_VERSION, "@string/developer_version_default");
        findPreference(KEY_DEVELOPER_VERSION).setEnabled(true);
        ...
        setValueSummary(KEY_PK_VERSION, "ro.pk.version");
        findPreference(KEY_PK_VERSION).setEnabled(true);
